...
/**
 * Homepage social preview: generated by `app/opengraph-image.tsx` (text + `public/og-home.jpg` background).
 * `?v=` cache-busts Facebook/LinkedIn when the design changes.
 */
export const SITE_HOME_OG_IMAGE = "/opengraph-image?v=6";

/** Alt text for the generated OG image (`export const alt` in `opengraph-image.tsx`). */
export const SITE_HOME_OG_IMAGE_ALT =
  "Hero headline on a coastal photo: a relocation planner built for families — visas, schools, housing, childcare, safety, and real family costs";
